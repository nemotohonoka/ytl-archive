...
<main>
  ...
  <section id="section-post" class="post-slide">
    ...
    <div class="posts">
      <?php
      $child_term = get_term_by('slug', 'child02-parent02', 'common_category');
    ...
    <div class="default-button">
      <button class="button-more library-more" data-parent="parent02" data-child="child02-parent02" data-post-type="material">
        <span>もっと見る</span>
      </button>
    </div>
  </section>
  ...
  <section id="section-post" class="post-movie">
    ...
    <div class="default-button">
      <button class="button-more library-more" data-parent="parent02" data-child="child02-parent02" data-post-type="video-library">
        <span>もっと見る</span>
      </button>
    </div>
  </section>
