...
<main>
  ...
  <section id="section-post" class="post-slide">
    ...
    <div class="posts">
      <?php
      // child01 のタームを取得
      $child_term = get_term_by('slug', 'child07-parent01', 'common_category');
    ...
    <div class="default-button">
      <button class="button-more library-more" data-parent="parent01" data-child="child07-parent01" data-post-type="material">
        <span>もっと見る</span>
      </button>
    </div>
  </section>
  ...
  <section id="section-post" class="post-movie">
    ...
    <div class="default-button">
      <button class="button-more library-more" data-parent="parent01" data-child="child07-parent01" data-post-type="video-library">
        <span>もっと見る</span>
      </button>
    </div>
